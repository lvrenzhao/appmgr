...
<c:if test='${fn:indexOf(param["libs"], "monthpicker") >= 0}'><link href="${ctx_assets_3rd}/monthpicker/jquery.monthpicker.css?v=${v}" rel="stylesheet"></c:if>
...
<c:if test='${fn:indexOf(param["libs"], "echarts") >= 0}'><script src="${ctx_assets_3rd}/echarts/echarts.common.min.js?v=${v}"></script></c:if>
...
<c:if test='${fn:indexOf(param["libs"], "xlsx") >= 0}'><script src="${ctx_assets_3rd}/xlsx/shim.js?v=${v}"></script><script src="${ctx_assets_3rd}/xlsx/xlsx.full.min.js?v=${v}"></script></c:if>
<c:if test='${fn:indexOf(param["libs"], "steps") >= 0}'><script src="${ctx_assets_3rd}/steps/jquery.steps.min.js?v=${v}"></script></c:if>
<c:if test='${fn:indexOf(param["libs"], "monthpicker") >= 0}'><script src="${ctx_assets_3rd}/monthpicker/jquery.monthpicker.js?v=${v}"></script></c:if>
