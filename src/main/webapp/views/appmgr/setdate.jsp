...
<head>
    ...
    <jsp:include page="/header.jsp?libs=laydate" />
</head>
<body>
<div class="form_center wb85 clearfix" style="padding: 15px 0;">
    ...
    <div class="form_item wb100">
        <label>设定新的服务截止日期</label>
        <input type="text" class="form-control" placeholder="" onclick="laydate({istime: true,format: 'YYYY/MM/DD'})"/>
    </div>
